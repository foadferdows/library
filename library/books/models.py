...
class Author(models.Model):
    ...
    country = models.CharField(choices=countries , blank=True , null=True)
...
class Book(models.Model):
    ...
    category = models.Choices(Category, on_delete=models.SET_NULL, null=True, blank=True, related_name="books")
